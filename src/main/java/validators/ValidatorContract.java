...
public class ValidatorContract {
     ...
     */
    public static String checkIDContract(final int id) {
        if (id <= 0) {
     ...
     * @return корректная/некорректная запись
     */
    public static String checkNumberContract(final int number) {
        if (number < 0) {
     ...
     * @return корректная/некорректная запись
     */
    public static String checkDateContract(final LocalDate start, final LocalDate end) {
     ...
     * @return корректная/некорректная запись
     */
    public static String checkTVContracts(final String[] addInfo) {
        if (addInfo.length == 1) {
            return "Корректная запись";
        } else {
     ...
     */
    public static String checkInternetContract(final String[] addInfo) {
     ...
     * @return корректная/неккоректная запись
     */
    public static String checkMobileContract(final String[] addInfo) {
     ...
     */
    public static String checkOwner(final LocalDate bDay) {
     ...
     * @return
     */
    public final ArrayList<String> resultValidateContracts(final Contract contract, final String contractType, final String[] addInfo) {
        result.clear();
